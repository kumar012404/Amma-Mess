                    ...
                    <div class="item-controls-container">
                        ...
                        <div style="display:flex; align-items:center; justify-content:space-between; width:100%; gap:2px; margin-bottom:4px;">
                            ...
                            <input type="number" min="1" value="1" id="sets-${item.name.replace(/\s+/g, '-')}" data-set-size="${item.defaultQty}"
                                style="width:55px; padding:1px 2px; border-radius:4px; border:1px solid #cbd5e1; font-size:0.75rem; text-align:center; height:20px;"
...
// Note: Monthly view panel, switchReportMode, fetchHistoryStats, and downloadCustomReportPDF 
// have been moved to reports.html and reports_page.js to serve as a separate page.
